...
export default function UserNotFound({ username }: {
    ...
    const [randomQuote, setRandomQuote] = useState<{ text: string, movie: string }>();
    ...
    useEffect(() => {
        ...
        const randomQuotePick = quotesData.quotes[Math.floor(Math.random() * quotesData.quotes.length)];
        ...
        <div className="container-xl px-4 py-5">
            <div className="row justify-content-center">
                <div className="col-md-8 col-lg-6 text-center">
                    <div className="card-container" style={{ position: "relative", overflow: "hidden" }}>
                        <p className="h1 fw-bold mb-4" style={{
                            color: "#f5f5f5",
                            fontSize: "70px"
                        }}>
                            404
                        ...
                        <div className="card border-0 shadow-lg" style={{
                            ...
                            <div className="card-body p-1" style={textStyle}>
                                ...
                                <div onClick={() => navigate("/" + generateHref(randomMedia as Media).split("#")[1].split("/")[1])} style={{
                                    ...
                                    <div className="card border-0 shadow-lg overflow-hidden rounded-4" style={{ background: "transparent", maxWidth: "320px", margin: "0 auto" }}>
                                        ...
                                        <div className="card-body text-center text-white p-3">
                                            <h5 className="mb-2">{randomMedia?.title || "Movie Title"}</h5>
